<?php
	...
	if(isset($_POST['Add'])){
		...
		// Add image to bootstrap/img/
		if(isset($_FILES['image']) && $_FILES['image']['name'] != ""){
			$image = $_FILES['image']['name'];
			$directory_self = str_replace(basename($_SERVER['PHP_SELF']), '', $_SERVER['PHP_SELF']);
			// if $_SERVER['PHP_SELF'] is '/myapp/script.php', the code would replace 'script.php'(basename) with an empty string, resulting in '/myapp/'
...
<div class="container" style="padding-top:30px;">
	...
	<div style="padding-top:10px;">
    	<p class="lead text-center text-muted" style="background-color:gold; width:fit-content; ;">ADD NEW BOOKS</p>
	</div>
	...
	<form method="post" action="admin_add.php" enctype="multipart/form-data">
		...
		<input type="submit" name="Add" value="Add New Book" class="btn btn-info">&nbsp;
